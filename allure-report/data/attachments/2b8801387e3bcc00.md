...
- Name: Logintest.spec.js >> Add product to cart
- Location: tests\Logintest.spec.js:83:6

# Error details

```
TypeError: this.addPhoneToCart.click is not a function
```
      ...
      - list [ref=e7]:
        ...
        - listitem [ref=e17]:
          - link "Log out" [ref=e18] [cursor=pointer]:
            - /url: "#"
        - listitem [ref=e19]:
          - link "Welcome reyatest56786879890091" [ref=e20] [cursor=pointer]:
            - /url: "#"
        - listitem
  - generic [ref=e22]:
    - generic [ref=e25]:
...
```ts
  ...
  5  |         this.phonecategory=page.locator("//a[text()='Phones']")
  6  |         this.phoneaddtocart=page.locator("//a[text()='Add to cart']")
  7  |     }
  8  | 
  9  |     async welcomeMessage()
  10 |     {
  11 |        const text= await this.welcometext.textContent()
  12 |        //console.log("welcome msg " +text)
  13 |     }
  14 | 
  15 |    async addPhoneToCart(phonename)
  16 |    {
  17 |     await this.page.locator(`//a[text()='${phonename}']`).click()
> 18 |     await this.addPhoneToCart.click()
     |                               ^ TypeError: this.addPhoneToCart.click is not a function
  19 |    }
  20 | }
```
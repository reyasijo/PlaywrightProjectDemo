...
- Location: tests\Logintest.spec.js:19:6
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: reyatest5678
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [ref=e15]: dgfdfghgfjhkk
        - generic [ref=e17]:
...
```ts
  ...
  17 | })
  18 | 
  19 | test.only('sign up as a new user', async({page})=>
  20 | {
...
> 27 |     expect(dialog.message()).toBe('Sign up successful.')
  ...
  42 |  await expect(productstorepage.welcometext).toContainText('Welcome')
  43 | })
  44 | 
  45 | test('login using incorrect usename', async({page})=>
  46 | {
  47 |  await loginpage.loginWithCreds(userData.logininvalidusername,userData.signuppassword)
  48 |  await loginpage.handleAlert()
  49 | }
  50 | )
```
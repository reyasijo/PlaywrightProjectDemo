...
Expected substring: "Thank you for your purchased!"
Received string:    "Thank you for your purchase!"
```
...
```ts
  ...
  54 |         await cartpage.placeorder('Apple monitor 24')
  55 |     expect(orderConfirmationText.trim())
> 56 |         .toContain('Thank you for your purchased!')
     |          ^ Error: expect(received).toContain(expected) // indexOf
  57 |     /*
  58 |     await cartpage.placeorder('Apple monitor 24')
  59 |     //console.log("Order confirmation text is:", orderConfirmationText)
  60 |     await expect(this.orderconfirmation).tobeVisible()
  61 |     //await expect(orderConfirmationText).toHaveText('Thank you for your purchase!')*/
  62 | })
  63 | 
  64 | 
  65 | 

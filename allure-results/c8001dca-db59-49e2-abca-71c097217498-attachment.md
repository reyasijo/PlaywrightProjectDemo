...
```
Error: toHaveText can be only used with Locator object, was called with Thank you for your purchase!
```
...
```ts
  ...
  53 |     const orderConfirmationText = await cartpage.placeorder('Apple monitor 24')
  54 |     console.log("Order confirmation text is:", orderConfirmationText)
> 55 |     await expect(orderConfirmationText).toHaveText('Thank you for your purchase!')
     |                                         ^ Error: toHaveText can be only used with Locator object, was called with Thank you for your purchase!
  56 | })
  57 | 
  58 | 

      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e11]:
            ...
            - 'textbox "Total: 400 Name:" [ref=e13]'
          - generic [ref=e14]:
...
> 25 |             await this.name.fill(userData[4].Name)
     |                             ^ Error: locator.fill: value: expected string, got undefined
  26 |             await this.country.fill(userData[4].Country)
  27 |             await this.city.fill(userData[4].City)
  28 |             await this.creditcard.fill(userData[4].Creditcard)
  29 |             await this.month.fill(userData[4].Month)
  30 |             await this.year.fill(userData[4].Year)

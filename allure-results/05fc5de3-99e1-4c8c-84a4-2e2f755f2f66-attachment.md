...
```
TypeError: loginpage.waitForEvent is not a function
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e13]:
            ...
            - textbox [active] [ref=e15]: dgfdfghgfjhkk
        - generic [ref=e17]:
...
> 49 |  const waitforalert = loginpage.waitForEvent('dialog')
     |                                 ^ TypeError: loginpage.waitForEvent is not a function
  50 |  await loginpage.handleAlert()

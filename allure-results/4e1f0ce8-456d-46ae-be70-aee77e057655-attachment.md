...
- Location: tests\Signuptest.spec.js:7:5

# Error details

```
TypeError: Cannot read properties of undefined (reading 'handleAlert')
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: reytest56786879890058
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [active] [ref=e15]: dgfdfghgfjhkkgf8
        - generic [ref=e17]:
...
```ts
  ...
  4  | import { AlertHandler } from "../Utils/AlertHandler"
  5  | let signuppage
  6  | let alerthandler
  7  | test('1. sign up as a new user', async({page})=>
  8  | {   
  9  |         
  10 |         signuppage = new SignupPage(page)
  11 |         await signuppage.goto()
  12 |         await signuppage.signUpEnterCreds(userData.signupusername,userData.signuppassword)
> 13 |         await alerthandler.handleAlert('Sign up successful.')
     |                            ^ TypeError: Cannot read properties of undefined (reading 'handleAlert')
  14 |         await signuppage.signUp()
  15 | })
```
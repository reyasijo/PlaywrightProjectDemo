...
- Location: tests\PurchaseItemTest.spec.js:32:5

# Error details

```
TypeError: cartpage.orderConfirmation is not a function
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e11]:
            ...
            - 'textbox "Total: 790 Name:" [ref=e13]': Reya
          - generic [ref=e14]:
...
> 42 |  await expect(cartpage.orderConfirmation()).toBeVisible()
  ...
  54 |     await expect(cartpage.orderConfirmation()).toBeVisible()
  55 | })
  56 | 
  57 | 
  58 | 

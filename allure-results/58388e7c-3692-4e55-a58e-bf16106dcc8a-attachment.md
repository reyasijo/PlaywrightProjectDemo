...
> 49 |     await productstorepage.selectCategory(dataset[5].monitorcategory)
     |                                                      ^ TypeError: Cannot read properties of undefined (reading 'monitorcategory')
  50 |     /*
  51 |     await alerthandler.handleAlert(dataset[3].productaddedalert)
  52 |     await productstorepage.addItemToCart(dataset[3].monitoritem)
  53 |     await alerthandler.handleAlert(dataset[3].productaddedalert)
  54 |     const orderConfirmationText =
  55 |     await cartpage.placeorder(dataset[3].monitoritem    )
  56 |     expect(orderConfirmationText.trim()).toContain('Thank you for your purchase!') */cls
  57 |   
  58 | })
  59 | 
  60 | 

...
- Name: Logintest.spec.js >> 6. login using incorrect username and password
- Location: tests\Logintest.spec.js:54:5
...
> 14 |         await this.loginusename.fill(user)
  ...
  25 |     async logout()
  26 |      {
  27 |         await this.logoutbtn.click()
  28 |         const title=await this.page.title()
  29 |         console.log("Title after logout is:", title)
  30 |         return title
  31 |         
  32 |      }}
```